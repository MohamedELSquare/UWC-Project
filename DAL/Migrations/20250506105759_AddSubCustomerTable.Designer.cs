...
namespace DAL.Migrations
{
    ...
    [Migration("20250506105759_AddSubCustomerTable")]
    partial class AddSubCustomerTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Models.Difinitions.SubCustomer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SubCustomers", "Definitions");
                });
            ...
            modelBuilder.Entity("DAL.Models.Difinitions.SubCustomer", b =>
                {
                    b.HasOne("DAL.Models.Difinitions.DCustomer", "DCustomer")
                        .WithMany("SubCustomers")
                        .HasForeignKey("DCustomerId");

                    b.Navigation("DCustomer");
                });

            modelBuilder.Entity("DAL.Models.JobOrder", b =>
                {
                    b.HasOne("DAL.Models.Difinitions.SubCustomer", "SubCustomer")
                        .WithMany("JobOrders")
